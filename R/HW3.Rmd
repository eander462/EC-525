...
stargazer(nbp_reg, type = 'text', keep.stat = c("N", "rsq"),
          style = 'qje', dep.var.labels = "NOx Emissions",
          covariate.labels = c("Summer", "Post", "Summer * Post (tau)"))
...
stargazer(no_nbp_reg, type = 'text', keep.stat = c("N", "rsq"),
          style = 'qje', dep.var.labels = "NOx Emissions",
          covariate.labels = c("Summer", "Post", "Summer * Post (tau)"))
```
...
stargazer(triple_diff_reg, type = 'text', keep.stat = c("N", "rsq"),
          style = 'qje', dep.var.labels = "NOx Emissions",
          covariate.labels = c("Treated", "Summer", "Post", "Treated * Summer",
                               "Treated * Post", "Summer * Post", "Treated * Summer * Post (tau)"))
```
